...
class Buffer {
    ...
    public Response Process(Request request) {
        //Pop from the list all that will be completed before my arrival time
        ...
        //If buffer isn't empty or full
        int finishTimePrevpack = finish_time_.get(finish_time_.size() - 1); 
        finish_time_.add(finishTimePrevpack + request.process_time);
        return new Response (false, finishTimePrevpack);
